...
use crate::daw_models::analysis::CompatibleFile;
use crate::daw_models::midi_file::MidiFile;
use tauri::State;
...
#[tauri::command]
pub async fn add_favorite(file_id: i32, state: State<'_, DawAppState>) -> Result<(), String> {
...
#[tauri::command]
pub async fn remove_favorite(file_id: i32, state: State<'_, DawAppState>) -> Result<(), String> {
...
#[tauri::command]
pub async fn is_favorite(file_id: i32, state: State<'_, DawAppState>) -> Result<bool, String> {
...
/// Get all favorite files with full details (DAW)
#[tauri::command]
pub async fn daw_get_favorites(
    state: State<'_, DawAppState>,
) -> Result<Vec<crate::daw_models::midi_file::FileDetails>, String> {
    debug!("Getting all favorite files");

    let favorites = sqlx::query_as!(
        crate::daw_models::midi_file::FileDetails,
        r#"
        SELECT
            f.id as "id!",
...
#[tauri::command]
pub async fn get_usage_stats(state: State<'_, DawAppState>) -> Result<String, String> {

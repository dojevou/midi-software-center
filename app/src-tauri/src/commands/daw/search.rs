...
use crate::daw_models::midi_file::FileDetails;
use crate::daw_models::search::{SearchFilters, SearchResponse, Suggestion};
use sqlx::Row;
use tauri::State;
...
/// Get detailed information about a specific file (DAW)
#[tauri::command]
pub async fn daw_get_file_details(
    file_id: i32,
    state: State<'_, DawAppState>,

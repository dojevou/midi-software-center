...
impl SequencerEngine {
    ...
    pub async fn schedule_event(
        &self,
        message: crate::core::midi::playback_types::MidiMessage,
        tick: u64,
        track_id: i32,
    ) {
    ...
    pub async fn get_track(&self, track_id: i32) -> Option<crate::daw_models::sequencer::Track> {
    ...
    pub async fn load_tracks(&self) {
        use crate::core::midi::playback_types::{MidiEventType as CoreEventType, MidiMessage};
        use crate::daw_models::midi::MidiEventType;
